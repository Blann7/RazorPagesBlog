...
namespace BlogPhone.Pages.Office
{
    ...
    public class UserModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            ...
            // Referral code
            Referral? referral = await context.Referrals.AsNoTracking().FirstOrDefaultAsync(r => r.UserId == SiteUser!.Id);
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            Referral referral = new (SiteUser!.Id);
        ...
        /// <summary>
        /// Fill SiteUser property with all data (FULL)
        /// </summary>
        /// <returns>(true, true) if prop filled ok.</returns>
